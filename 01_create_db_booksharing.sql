...
CREATE TABLE books_on_stock (
	...
	received_from BIGINT UNSIGNED COMMENT 'От какого пользователя получена книга',  
	registred_at DATETIME DEFAULT CURRENT_TIMESTAMP,
	updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	reserved_by BIGINT UNSIGNED DEFAULT NULL COMMENT 'Каким пользователем зарезервирована книга',
	received_by BIGINT UNSIGNED DEFAULT NULL COMMENT 'Какой пользователь забрал книгу',
